...
class Helmet(context: Context, screenX: Int, screenY: Int, ):Item {
    override var bitmap: Bitmap = BitmapFactory.decodeResource(context.resources, R.drawable.helmet_icon)
